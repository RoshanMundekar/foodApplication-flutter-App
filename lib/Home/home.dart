...
import 'package:foodapp/Home/requested.dart';
          ...
          child: new ListView(
            children: [
              ...
              new ListTile(
                ...
                onTap: (){
                  Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context)=>addfoods()));
                },
              ),
              new ListTile(
                title: new Text("CUSTOMERS ADDED PRODUCTS"),
                trailing: new Icon(Icons.production_quantity_limits),
                onTap: (){
                  Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context)=>CardDetailPage()));
                },
              ),
              ...
              new ListTile(
                title: new Text("CUSTOMERS ORDERS"),
                trailing: new Icon(Icons.request_page),
                onTap: (){
                  Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context)=>CustomerOrder()));
                },
              ),
              new ListTile(
              ...
              new ListTile(
                title: new Text("REQUESTD PRODUCTS"),
                trailing: new Icon(Icons.request_page),
                onTap: (){
                  Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context)=>requested()));
                },
              ),
              new ListTile(
