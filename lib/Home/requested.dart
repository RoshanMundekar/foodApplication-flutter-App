...
class _requestedState extends State<requested> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text('PRODUCT REQUESTS USERS'),
        ),
                                      ...
                                      children: [
                                        ...
                                        ElevatedButton(
                                            ...
                                            onPressed: () async {
                                              ...
                                              final url = serverurl+"Aceptreq";
                                              final response = await http.post(Uri.parse(url), body: json.encode({'productname' :characterList[index][1],'username' : characterList[index][6]}));
...
class CharacterApi {
  static Future getCharacters(data) {
    return http.get(Uri.parse(serverurl+"requested"));
  }
}
