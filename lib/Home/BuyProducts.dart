...
class buypro extends StatefulWidget {

  @override
  State<buypro> createState() => _buyproState();
}

class _buyproState extends State<buypro> {
  List characterList = [];
...
class CharacterApi {
  static Future getCharacters(data) {
    return http.get(Uri.parse(serverurl+"reciveproduct/"+globalString));
  }
}
